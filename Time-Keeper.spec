...
hiddenimports = ['flask_sqlalchemy', 'flask', 'webview', 'flask_migrate', 'flask_admin', 'flask_cors', 'sqlalchemy', 'werkzeug', 'alembic', 'webview.platforms.winforms', 'clr', 'webview.window', 'sqlite3', 'sqlalchemy.ext.declarative', 'sqlalchemy.orm', 'sqlalchemy.dialects.sqlite', 'sqlalchemy.sql.default_comparator', 'sqlalchemy.event', 'sqlalchemy.pool', 'winotify', 'winreg', 'flask_sqlalchemy.model', 'flask_sqlalchemy.extension', 'flask_migrate.cli', 'flask_migrate.templates', 'sqlalchemy.dialects.sqlite.pysqlite', 'sqlalchemy.engine.result', 'sqlalchemy.sql.functions', 'sqlalchemy.sql.schema', 'sqlalchemy.dialects.sqlite.base', 'alembic.runtime.migration', 'alembic.context', 'alembic.script', 'alembic.ddl']
